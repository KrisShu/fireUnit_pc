<template>
  <el-dialog id="printBox" class="unit-report" :visible.sync="show" width="30%">
    ...
    <div id="diaBody">
      <div>
        <div>智慧消防报告单</div>
        <img src="../assets/image/index/reportTitle.png" />
      </div>
      <div class="title">
        <img src="../assets/image/index/report_img_icon01.png" />单位基本信息
      </div>
      <div class="content">
        <el-form>
          <el-form-item
      ...
      <div class="title">
        <img src="../assets/image/index/report_img_icon02.png" />火警报警监控
      </div>
      <div class="content">
        <ul>
      ...
      <div class="title">
        <img src="../assets/image/index/report_img_icon03.png" />安全用电监控
      </div>
      <div class="content">
        <ul>
          <li>
      ...
      <div class="title">
        <img src="../assets/image/index/report_img_icon04.png" />设施故障监控
      </div>
      <div class="content">
        <ul>
          <li>
      ...
      <div class="title">
        <img src="../assets/image/index/report_img_icon05.png" />值班巡查记录
      </div>
      <div class="content">
        <ul>
          <li>
      ...
      <div class="title">
        <img src="../assets/image/index/report_img_icon06.png" />周边消防设施（1KM范围内）
      </div>
      <div class="content">
        <ul>
...
export default {
  ...
  data() {
    return {
      ...
      formList: [
        {
          label: "名称：",
          icon: require("../assets/image/index/report_img_01.png"),
          value: "fireUnitName"
        },
        {
          label: "类型：",
          icon: require("../assets/image/index/report_img_02.png"),
          value: "type"
        },
        {
          label: "区域：",
          icon: require("../assets/image/index/report_img_03.png"),
          value: "area"
        },
        {
          label: "联系人：",
          icon: require("../assets/image/index/report_img_04.png"),
          value: "contractName"
        },
        {
          label: "联系方式：",
        ...
        {
          label: "维保单位：",
          icon: require("../assets/image/index/report_img_05.png"),
          value: "safeUnit"
        },
        {
          label: "地址：",
          icon: require("../assets/image/index/report_img_06.png"),
          value: "address"
        }
      ]
    };
  ...
  methods: {
    // todo 获取打印数据
    getInfo(FireUnitId) {
        console.log("FireUnitId",FireUnitId)
      this.$axios
        ...
        .then(res => {
          ...
          if (res.data.success) {
            ...
            let d = {};
            Object.assign(d, this.deform, res.data.result);
            this.form = d;
            this.show = true;
          }
        })
